...
function GalleryTile({
  ...
  return (
    ...
    >
      ...
      />
      <span className="absolute inset-0 bg-gradient-to-t from-background/80 via-transparent to-transparent opacity-0 transition-opacity group-hover:opacity-100" />
      <span className="absolute bottom-4 left-4 text-left text-sm opacity-0 transition-opacity group-hover:opacity-100">
        {item.alt}
      </span>
    </button>
  );
